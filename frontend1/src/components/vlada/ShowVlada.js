...
function ShowVlada(props) {
  ...
  console.log(props)
    ...
    const getProduct = async () => {
        const response = await axios.get("http://127.0.0.1:8000/vlada/")
...
return(
    <div className="showProduct-nav">
      <NavBarMenu/>
      <h3 className="ugljesa-h3">Vlada</h3>
      <Link className="btn btn-success" to={'/addvlada'}>Dodaj Novo</Link>
        {
