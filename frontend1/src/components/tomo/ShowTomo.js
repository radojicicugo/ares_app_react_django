...
function ShowTomo(props) {
  ...
  console.log(props)
    ...
    const getProduct = async () => {
        const response = await axios.get("http://127.0.0.1:8000/tomo/")
...
return(
    <div className="showProduct-nav">
      <NavBarMenu/>
      <h3 className="ugljesa-h3">Tomo</h3>
      <Link className="btn btn-success" to={'/addtomo'}>Dodaj Novo</Link>
        {
...
<Container className="map">
  ...
  <Card.Body className="body-body">
    ...
    <Link to={`/${el.id}/updatetomo`} className="btn btn-primary" >Detail</Link>
  </Card.Body>
</Card>
</Container>
            ))
