...
function ShowProduct(props) {
  ...
  console.log(props)
    ...
    const getProduct = async () => {
        const response = await axios.get("http://127.0.0.1:8000/ugljesa/")
...
return(
    <div className="showProduct-nav">
      <NavBarMenu/>
      <h3 className="ugljesa-h3">Ugljesa</h3>
      <Link className="btn btn-success" to={'/addproduct'}>Dodaj Novo</Link>
        {
