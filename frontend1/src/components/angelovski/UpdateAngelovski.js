...
function UpdateAngelovski(props) {
   ...
   // const history = useHistory();
    ...
    const loadProducts = async () => {
      const result = await axios.get(`http://localhost:8000/angelovski/${id}`)
   ...
   const UpdateProductInfo = async () => {
    ...
    await axios({
        method: 'PUT',
        url: `http://localhost:8000/angelovski/${id}/`,
        data: formField
    }).then(response => {
...
export default UpdateAngelovski;